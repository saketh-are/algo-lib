...
* [Usage](https://github.com/saketh-are/algo-lib/tree/readme#Usage)
  ...
  * [Passing iterators as arguments](https://github.com/saketh-are/algo-lib/tree/readme#passing-iterators-as-arguments)
* [Data Structures](https://github.com/saketh-are/algo-lib/tree/readme#data-structures)
  * [Segment Tree](https://github.com/saketh-are/algo-lib/tree/readme#segment-tree)
  * [Binary Indexed Tree](https://github.com/saketh-are/algo-lib/tree/readme#binary-indexed-tree)
  * [Sparse Table](https://github.com/saketh-are/algo-lib/tree/readme#sparse-table)
* [Graphs](https://github.com/saketh-are/algo-lib/tree/readme#graphs)
  * [Tree](https://github.com/saketh-are/algo-lib/tree/readme#tree)
  * [Lowest Common Ancestor](https://github.com/saketh-are/algo-lib/tree/readme#lowest-common-ancestor)
  * [Heavy Path Decomposition](https://github.com/saketh-are/algo-lib/tree/readme#heavy-path-decomposition)
  * [Dijkstra](https://github.com/saketh-are/algo-lib/tree/readme#dijkstra)
...
* [Numeric](https://github.com/saketh-are/algo-lib/tree/readme#numeric)
  ...
  * [Complex FFT](https://github.com/saketh-are/algo-lib/tree/readme#complex-fft)
  * [Discrete Logarithm](https://github.com/saketh-are/algo-lib/tree/readme#discrete-logarithm)
  * [Tonelli-Shanks](https://github.com/saketh-are/algo-lib/tree/readme#tonelli-shanks)
* [Strings](https://github.com/saketh-are/algo-lib/tree/readme#strings)
  * [Knuth-Morris-Pratt](https://github.com/saketh-are/algo-lib/tree/readme#knuth-morris-pratt)
  * [Z Algorithm](https://github.com/saketh-are/algo-lib/tree/readme#z-algorithm)
  * [Palindromes](https://github.com/saketh-are/algo-lib/tree/readme#palindromes)
  * [Polynomial Hash](https://github.com/saketh-are/algo-lib/tree/readme#polynomial-hash)
  * [Suffix Array](https://github.com/saketh-are/algo-lib/tree/readme#suffix-array)
  * [Suffix Automaton](https://github.com/saketh-are/algo-lib/tree/readme#suffix-automaton)
  * [Trie](https://github.com/saketh-are/algo-lib/tree/readme#trie)
  * [Mutable String](https://github.com/saketh-are/algo-lib/tree/readme#mutable-string)
  * [Mutable String (Bitset)](https://github.com/saketh-are/algo-lib/tree/readme#mutable-string-bitset)
  
## Usage

All classes compile on C++ 17.

Some files require the contents of other files, denoted by a comment `// {{{ <filepath> }}}`. If you would like to generate buildable code from the usage examples, [a small script](https://github.com/saketh-are/algo-lib/blob/readme/.circleci/expand_dependencies.py) is provided to pull in dependencies. Run:
...
### [Segment Tree](https://github.com/saketh-are/algo-lib/blob/readme/data_structures/segment_tree.cpp)
...
Less general than a [Segment Tree](https://github.com/saketh-are/algo-lib/tree/readme#segment-tree); offers better constant factor performance.

 __Usage Examples:__
* [Point Add Range Sum](https://github.com/saketh-are/algo-lib/blob/readme/test/data_structures/binary_indexed_tree/point_add_range_sum/point_add_range_sum.cpp)

### [Sparse Table](https://github.com/saketh-are/algo-lib/blob/readme/data_structures/sparse_table.cpp)
...
Precomputation is `O(N log(N)`. Typically used with `f = min<T>` or `f = max<T>`.
 ...
 __Usage Examples:__
* [Static RMQ](https://github.com/saketh-are/algo-lib/blob/readme/test/data_structures/sparse_table/static_rmq/static_rmq.cpp)

## Graphs

### [Tree](https://github.com/saketh-are/algo-lib/blob/readme/graphs/tree.cpp)
...
__Usage Examples:__
* [Weighted Tree Diameter](https://github.com/saketh-are/algo-lib/blob/readme/test/graphs/tree/weighted_tree_diameter/weighted_tree_diameter.cpp)

### [Lowest Common Ancestor](https://github.com/saketh-are/algo-lib/blob/readme/graphs/lowest_common_ancestor.cpp)
...
__Usage Examples:__
* [Lowest Common Ancestor](https://github.com/saketh-are/algo-lib/blob/readme/test/graphs/lowest_common_ancestor/lowest_common_ancestor/lowest_common_ancestor.cpp)

### [Heavy Path Decomposition](https://github.com/saketh-are/algo-lib/blob/readme/graphs/heavy_path_decomposition.cpp)
...
Accepts an instance of the [Tree](https://github.com/saketh-are/algo-lib/tree/readme#tree) class. Additional precomputation is `O(V)`.

__Usage Examples:__
* [Vertex Add Path Sum](https://github.com/saketh-are/algo-lib/blob/readme/test/graphs/heavy_path_decomposition/vertex_add_path_sum/vertex_add_path_sum.cpp)

### [Dijkstra](https://github.com/saketh-are/algo-lib/blob/readme/graphs/tree.cpp)
...
__Usage Examples:__
* [Shortest Path](https://github.com/saketh-are/algo-lib/blob/readme/test/graphs/dijkstra/shortest_path/shortest_path.cpp)

### [Two Sat](https://github.com/saketh-are/algo-lib/blob/readme/graphs/two_sat.cpp)
...
Classifies each variable as true in all satisfying assignments, false in all satisfying assignments, or neither. Runtime is `O(N * N / MACHINE_WORD_SIZE)`.
 ...
 __Usage Examples:__
* [Two Sat](https://github.com/saketh-are/algo-lib/blob/readme/test/graphs/two_sat/two_sat/two_sat.cpp)

## Misc

### [Subset Sum](https://github.com/saketh-are/algo-lib/blob/readme/misc/subset_sum.cpp)
...
### [ModNum](https://github.com/saketh-are/algo-lib/blob/readme/numeric/modnum.cpp)
...
`MOD` is configured as a template parameter. If the modulus isn't know at compile-time, move `MOD` inside the struct as a static member.
 ...
 __Usage Examples:__
 * [Exponentiation](https://github.com/saketh-are/algo-lib/blob/readme/test/numeric/modnum/exponentiation/exponentiation.cpp)
 
 ### [Number Theoretic Transform](https://github.com/saketh-are/algo-lib/blob/readme/numeric/ntt.cpp)
 ...
 __Usage Examples:__
 * [Convolution Mod 998244353](https://github.com/saketh-are/algo-lib/blob/readme/test/numeric/ntt/convolution_mod_998244353/convolution_mod_998244353.cpp)
 
 ### [Complex FFT](https://github.com/saketh-are/algo-lib/blob/readme/numeric/complex_fft.cpp)
 
 Convolves polynomials over the field of doubles.
 
 Provides a routine for convolution of polynomials over the integers modulo `P` _without_ [Number Theoretic Transform](https://github.com/saketh-are/algo-lib/blob/readme/numeric/ntt.cpp)'s constraint that `D` divides `P - 1`. This routine seems to be safe for `N,M <= 150,000` but isn't precise enough for some adversarial cases around `N = M = 180,000`.
 
 __Usage Examples:__
 * [Convolution Mod 1000000007](https://github.com/saketh-are/algo-lib/blob/readme/test/numeric/complex_fft/convolution_mod_1000000007/convolution_mod_1000000007.cpp)

 ### [Discrete Logarithm](https://github.com/saketh-are/algo-lib/blob/readme/numeric/discrete_logarithm.cpp)
 ...
 __Usage Examples:__
 * [Discrete Logarithm](https://github.com/saketh-are/algo-lib/blob/readme/test/numeric/discrete_logarithm/discrete_logarithm/discrete_logarithm.cpp)
 
 ### [Tonelli-Shanks](https://github.com/saketh-are/algo-lib/blob/readme/numeric/tonelli-shanks.cpp)
 ...
 __Usage Examples:__
 * [Sqrt Mod](https://github.com/saketh-are/algo-lib/blob/readme/test/numeric/tonelli-shanks/sqrt_mod/sqrt_mod.cpp)
 
## Strings

### [Knuth-Morris-Pratt](https://github.com/saketh-are/algo-lib/blob/readme/strings/knuth_morris_pratt.cpp)
...
Precomputation is `O(|S|)`.
 ...
 __Usage Examples:__
 * [Pattern Find](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/knuth_morris_pratt/pattern_find/pattern_find.cpp)

### [Z Algorithm](https://github.com/saketh-are/algo-lib/blob/readme/strings/z_algorithm.cpp)
Given a string `S`, computes the length of the longest common prefix between `S` and each of its suffixes.

Runs in `O(|S|)`.

 __Usage Examples:__
 * [Z Algorithm](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/z_algorithm/z_algorithm/z_algorithm.cpp)

### [Palindromes](https://github.com/saketh-are/algo-lib/blob/readme/strings/palindromes.cpp)
Given a string `S`:
...
Precomputation is `O(|S|)`. Additional precomputation for substring queries is `O(|S| log(|S|))`.
 ...
 __Usage Examples:__
 * [Enumerate Palindromes](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/palindromes/enumerate_palindromes/enumerate_palindromes.cpp)

### [Polynomial Hash](https://github.com/saketh-are/algo-lib/blob/readme/strings/polynomial_hash.cpp)
...
Increasing parameter _EvaluationPoints_ lowers the probability of two distinct strings producing the same hash.
 ...
 __Usage Examples:__
 * [Good Substrings](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/polynomial_hash/good_substrings/good_substrings.cpp)

### [Suffix Array](https://github.com/saketh-are/algo-lib/blob/readme/strings/suffix_array.cpp)
Given a string `S`:
...
__Usage Examples:__
* [Suffix Array](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/suffix_array/suffix_array/suffix_array.cpp)
* [Count Distinct Substrings](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/suffix_array/count_distinct_substrings/count_distinct_substrings.cpp)

### [Suffix Automaton](https://github.com/saketh-are/algo-lib/blob/readme/strings/suffix_automaton.cpp)
...
__Usage Examples:__
* [Count Distinct Substrings](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/suffix_automaton/count_distinct_substrings/count_distinct_substrings.cpp)

### [Trie](https://github.com/saketh-are/algo-lib/blob/readme/strings/trie.cpp)
...
__Usage Examples:__
* [Minimum Length Substring With K Occurrences](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/trie/minimum_length_substring_with_k_occurrences/minimum_length_substring_with_k_occurrences.cpp)

### [Mutable String](https://github.com/saketh-are/algo-lib/blob/readme/strings/mutable_string.cpp)
...
__Usage Examples:__
* [Count Matches in Mutable Text](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/mutable_string/count_matches_in_mutable_text/count_matches_in_mutable_text.cpp)

### [Mutable String (Bitset)](https://github.com/saketh-are/algo-lib/blob/readme/strings/mutable_string_bitset.cpp)
Maintains a string over a finite alphabet, supporting:
...
__Usage Examples:__
* [Count Matches in Mutable Text](https://github.com/saketh-are/algo-lib/blob/readme/test/strings/mutable_string_bitset/count_matches_in_mutable_text/count_matches_in_mutable_text.cpp)
